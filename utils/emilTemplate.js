                                                   ...
                                                   <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                      <tr>
                                                         <td valign="top" class="imageContent">
                                                               <h1 style="font-weight: 700;font-size: 22px;text-align: center;">${
                                                                 data.subject
                                                               }</h1>
                                                         </td>
                                                      </tr>
                                                         ...
                                                         <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0 40px;">
                                                               <tr>
                                                                  ...
                                                                  <br />
                                                                  <br /> 
                                                                    Someone with the following details want to contact BDATA.Please review the Following details.
                                                                  <br />
                                                                   <br />
                                                                    <br />
                                                                  First Name - ${
...
export const partnerShipEmailTemplate = (
  data
) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" style="height: 100%;">
         <head>
...
export const downloadWhitePaperEmail = (
  data
) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" style="height: 100%;">
         <head>
                                             ...
                                             <tr>
                                                <td align="center" valign="top">
                                                   <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                      <tr>
                                                         <td valign="top" class="imageContent">
                                                               <h1 style="font-weight: 700;font-size: 22px;text-align: center;">${data?.subject}</h1>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0 40px;">
                                                               <tr>
                                                                  ...
                                                                  <br />
                                                                   <br />
                                                                  ${data.firstName} ${data.lastName} (${data.email}) has downloaded <strong>${data.pdf}</strong>
                                                                  <br />
                                                                  <br />
                                                                  <br />
...
export const whitepaperDownloadReceiver = (data) => `<!DOCTYPE html>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0 40px;">
                                                               <tr>
                                                                  ...
                                                                  Hi ${
                                                                    ...
                                                                    <br />
                                                                  Please download document through this link ${
                                                                    data.pdf
                                                                  }
                                                                  <br />
                                                                  Thanks,
