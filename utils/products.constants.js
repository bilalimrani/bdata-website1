export default {
  ...
  products: {
    ...
    section2: {
      ...
      valunerabilities2:
        " Infected office network may break into the plant network due to misconfigured or compromised firewalls ",
      valunerabilities3:
        " Infected laptop or USB/Bluetooth/Wireless devices brought into the plant network can distribute malwares across the plant network",
      valunerabilities4:
        " 3rd party connection to plant network for remote diagnostic may expose the network ",
      valunerabilities5:
        " Infected PLC Logic and insecure serial links may be introduced during maintenance/ installation/ modification/patching/ development activities",
    },
  },
};
