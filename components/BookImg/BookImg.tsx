...
const BookImg = () => {
  return (
    ...
    <BookImgWrapper>
        ...
        <h6 className="fw-bold">Advance Cyber Security for Critical Infrastructure</h6>
        ...
        <p className="fw-bold text-center yellow-text m-0">BDATA Solution Inc</p>
        <p className="fw-bold text-center yellow-text m-0 p-0">info@Bdata.ca</p>
        </div>
    </BookImgWrapper>
    </>
  );
