...
import Logo from "public/img/footerlogo.svg";
        ...
        <div className="row">
          <div className="col-sm-6">
            ...
            <div className="address-wrapper py-3">
              <p>07 Agro Sr Waterdown <br />ON L8B 1Y2.<br /> BDATA Solution Inc</p>
            </div>
            <div className="address-wrapper py-3">
              <p>© 2022 BDATA Inc.</p>
            </div>
            ...
            <div className="row">
              ...
              <h5 className="fw-bold m-0 mb-2">Main Pages</h5>
                <ul className="footer-links-ul">
                  ...
                  <li><a href="#" className="footer-links">Industries</a></li>
                  <li><a href="#" className="footer-links">Product</a></li>
                </ul>
              </div>
              <div className="col-lg-4 col-sm-6 col-12">
              ...
              <ul className="footer-links-ul">
                  <li><a href="#" className="footer-links">About Us</a></li>
                  <li><a href="#" className="footer-links">Terms</a></li>
              ...
              <ul className="footer-links-ul">
                  <li><a href="#" className="footer-links">Documentation</a></li>
                  <li><a href="#" className="footer-links">License</a></li>
                </ul>
              </div>
            </div>
          </div>
