                ...
                <FullContainer>
                  ...
                  <FeatureListing>
                    <h4 className="fw-bold">
                      {productConstants.products.section2.feature1}
                    </h4>
                  ...
                  <h4 className="fw-bold">
                    {productConstants.products.section2.application1}
                  </h4>
                  ...
                  <div className="row my-lg-2">
                    ...
                    <div className="col-12 col-md-6 py-2">
                      <h4 className="fw-bold">
                        {productConstants.products.section2.valunerability}
                      </h4>
                      <CustomUl>
                        <li>
                          <span>1</span>
                          {productConstants.products.section2.valunerabilities1}
                        </li>
                        <li>
                          <span>2</span>
                          {productConstants.products.section2.valunerabilities2}
                        </li>
                        <li>
                          <span>3</span>
                          {productConstants.products.section2.valunerabilities3}
                        </li>
                        <li>
                          <span>4</span>
                          {productConstants.products.section2.valunerabilities4}
                        </li>
                        <li>
                          <span>5</span>
                          {productConstants.products.section2.valunerabilities5}
                        </li>
                      </CustomUl>
                    </div>
                  </div>
